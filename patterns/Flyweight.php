 ...
 * This is done largely to assist performance, and works best when a large number of the exact same instance of a class
 * would otherwise be created.
 * In this example, the FlyweightBook class stores only author and title, with only three possible author title combinations
 * being used by the system, and yet the system may have a large number of duplicate books.

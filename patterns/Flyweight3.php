 ...
 *
 * Stack of log messages can be pretty long. Here in the example identical messages are not duplicated.
 * Instead by request the flyweight shared message object returns.
 */

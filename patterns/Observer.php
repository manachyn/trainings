 ...
 * Почему-то здесь Observer(наблюдатель) и Наблюдаемый(AbstractSubject) реализованы через абстрактные классы,
 * хотя обычно для этого паттерна они реализуются в виде интерфейсов
 */
